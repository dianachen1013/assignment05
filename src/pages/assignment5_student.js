    ...
    return (
        <Container>
            <Row className={"justify-content-md-left"}>
                <Col lg={10}>
                    <h1 className={styles.h1Style}>Airlines Routes</h1> {/* Apply CSS class */}
                </Col>
            </Row>
            <Row className={"justify-content-md-left"}>
                <Col lg={4}>
                    <h2>Airlines</h2>
                    <svg id={"barchart"} className={styles.svgStyle} width={barchart_width} height={barchart_height}> {/* Apply CSS class */}
                        <BarChart
                ...
                <Col lg={4}>
                    <h2>Airports</h2>
                    <svg id={"map"} className={styles.svgStyle} width={map_width} height={map_height}> {/* Apply CSS class */}
                        <AirportMap
                            width={map_width}
                            height={map_height}
                            countries={map}
